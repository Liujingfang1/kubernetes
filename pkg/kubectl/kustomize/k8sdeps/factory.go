...
import (
	"k8s.io/kubernetes/pkg/kubectl/kustomize/k8sdeps/kunstruct"
	"k8s.io/kubernetes/pkg/kubectl/kustomize/k8sdeps/transformer"
	"k8s.io/kubernetes/pkg/kubectl/kustomize/k8sdeps/validator"
